...
public class IntakeSubCommand extends Command {
    ...
    protected void execute() {
    	if(ActivateButtonCommand.isActive) {
    		if (IntakeButtonCommand.isPressed && OuttakeButtonCommand.isPressed) {
    			Robot.intake.setIntakePower(0);
    		}
    		else if(IntakeButtonCommand.isPressed) {
    			Robot.intake.setIntakePower(.7);
    		}
    		else if(OuttakeButtonCommand.isPressed) {
    			Robot.intake.setIntakePower(-.7);
    		}
    		else {
    			Robot.intake.setIntakePower(0);
